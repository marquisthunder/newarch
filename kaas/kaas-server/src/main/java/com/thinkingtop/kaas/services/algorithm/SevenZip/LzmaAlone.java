...
public class LzmaAlone
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		if (params.Command == CommandLine.kBenchmak)
		{
			...
			com.thinkingtop.kaas.services.algorithm.SevenZip.LzmaBench.LzmaBenchmark(params.NumBenchmarkPasses, dictionary);
		}
		else if (params.Command == CommandLine.kEncode || params.Command == CommandLine.kDecode)
		{
			...
			{
				com.thinkingtop.kaas.services.algorithm.SevenZip.Compression.LZMA.Encoder encoder = new com.thinkingtop.kaas.services.algorithm.SevenZip.Compression.LZMA.Encoder();
			...
			else
			{
				...
				com.thinkingtop.kaas.services.algorithm.SevenZip.Compression.LZMA.Decoder decoder = new com.thinkingtop.kaas.services.algorithm.SevenZip.Compression.LZMA.Decoder();
