...
public class MyBoneCPDataSource extends MyBoneCPConfig implements DataSource {
	/** Serialization UID. */
	...
	/** Class logger. */
	private static final Logger logger = LoggerFactory.getLogger(MyBoneCPDataSource.class);
	/**
	 * Default empty constructor.
	 *
	 */
	public MyBoneCPDataSource() {
		// default constructor
	}
	/**
	 * 
	 ...
	 * @param config
	 */
	public MyBoneCPDataSource(MyBoneCPConfig config) {
		Field[] fields = MyBoneCPConfig.class.getDeclaredFields();
	...
	* system timeout if there is one; otherwise, it specifies that there is no timeout. When a DataSource object is created, the login timeout is initially zero.
	 ...
	 * @return the config
	 */
	public MyBoneCPConfig getConfig() {
		return this;
	}
