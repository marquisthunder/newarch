 ...
 */
public class KaasPathMatchingResourcePatternResolver implements ResourcePatternResolver {

	private static final Log logger = LogFactory.getLog(KaasPathMatchingResourcePatternResolver.class);
	...
	static {
		...
		try {
			Class<?> fileLocatorClass = KaasPathMatchingResourcePatternResolver.class.getClassLoader().loadClass(
	 ...
	 */
	public KaasPathMatchingResourcePatternResolver() {
		this.resourceLoader = new KaasClassLoader();
//		this.resourceLoader = new DefaultResourceLoader();
	 ...
	 * @see org.springframework.core.io.DefaultResourceLoader
	 */
	public KaasPathMatchingResourcePatternResolver(ClassLoader classLoader) {
	 ...
	 */
	public KaasPathMatchingResourcePatternResolver(ResourceLoader resourceLoader) {
